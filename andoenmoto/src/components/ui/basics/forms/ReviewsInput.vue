...
<div class="alpha mt-5">
  ...
  <div class="review-preview d-flex">
    <div
      ...
      v-for="(completeReview, completeReviewIndex) in Object.keys(this.featureReviews)"
      :key="completeReviewIndex"
    >
      <i class="fa fa-check-circle" style="font-size:.9em; color:green;" aria-hidden="true"></i>
      <p>
        {{completeReview}}
      </p>
    </div>
  ...
  >
    <basic-button
      :content="featureReviews === {} ? 'Elegir características' : 'Agregar otra cracterística'"
      :secondary="true"
      style="font-size:5vw;"
    />
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      addingFeature: false,
      uploaded: false,
      // featureReviewsArray: Object.keys(this.featureReviews),
    };
  },
  computed: {
    ...mapState({
